...
<form id="regForm" action="/action_page.php">
    ...
    <div class="tab">
        ...
        <p><input placeholder="Prenoms" oninput="this.className = ''" name="fname" required></p>
    ...
    <div class="tab">Login Info:
        ...
        <p><input placeholder="Entrez votre mot de passe" oninput="this.className = ''" name="pword" type="password"
                  required></p>
